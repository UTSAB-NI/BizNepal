...
namespace BizNepal.Server.Migrations
{
    ...
    [Migration("20241112174012_added Icon in Category")]
    partial class addedIconinCategory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizNepal.Server.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = new Guid("412050d6-0779-4666-a273-65429733bcb7"),
                            CategoryName = "Resturant"
                        },
                        new
                        {
                            CategoryId = new Guid("f7eb803a-5eaf-49c0-8327-f220bbb1e19e"),
                            CategoryName = "Cafe"
                        },
                        new
                        {
                            CategoryId = new Guid("d4a6d983-62ec-4f6f-8e03-4a783cfb952f"),
                            CategoryName = "Hospital"
                        },
                        new
                        {
                            CategoryId = new Guid("93f12ebf-6251-4dfa-89e0-355310a88a75"),
                            CategoryName = "Hotels"
                        },
                        new
                        {
                            CategoryId = new Guid("86a50d76-7abe-4ec0-beb1-920f653ec0dc"),
                            CategoryName = "Gym"
                        },
                        new
                        {
                            CategoryId = new Guid("02f29cb1-0ab3-4832-9702-f338787fbc70"),
