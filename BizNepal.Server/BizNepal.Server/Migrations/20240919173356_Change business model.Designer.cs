...
namespace BizNepal.Server.Migrations
{
    ...
    [Migration("20240919173356_Change business model")]
    partial class Changebusinessmodel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizNepal.Server.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = new Guid("d9ba161f-1bdb-4793-b5e9-8ef4598c769e"),
                            CategoryName = "Resturant"
                        },
                        new
                        {
                            CategoryId = new Guid("4994fa1d-067f-4624-9500-a7af2ae6d56d"),
                            CategoryName = "Cafe"
                        },
                        new
                        {
                            CategoryId = new Guid("db5ab1c4-d2e8-453d-bdb1-0b540acdaa33"),
                            CategoryName = "Hospital"
                        },
                        new
                        {
                            CategoryId = new Guid("e39cf986-57a5-4692-a0d2-0d60cfbc9df8"),
                            CategoryName = "Hotels"
                        },
                        new
                        {
                            CategoryId = new Guid("5bcf9a21-560e-4e68-a2c3-7de206bbcd85"),
                            CategoryName = "Gym"
                        },
                        new
                        {
                            CategoryId = new Guid("a2340f4d-4d53-4a92-a250-c37147403bec"),
