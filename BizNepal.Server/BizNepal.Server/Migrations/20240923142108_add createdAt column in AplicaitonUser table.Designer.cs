...
namespace BizNepal.Server.Migrations
{
    ...
    [Migration("20240923142108_add createdAt column in AplicaitonUser table")]
    partial class addcreatedAtcolumninAplicaitonUsertable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizNepal.Server.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = new Guid("9eac2a0b-9ed3-4b6f-a0d1-7a3f33452dbe"),
                            CategoryName = "Resturant"
                        },
                        new
                        {
                            CategoryId = new Guid("89ea7c12-20bc-4f80-b7cc-b612f23499a2"),
                            CategoryName = "Cafe"
                        },
                        new
                        {
                            CategoryId = new Guid("804adda0-7892-458d-8772-3967b52f9b68"),
                            CategoryName = "Hospital"
                        },
                        new
                        {
                            CategoryId = new Guid("e4bfe284-42c8-40e0-9c8a-a3bd38b743de"),
                            CategoryName = "Hotels"
                        },
                        new
                        {
                            CategoryId = new Guid("f577d4f7-3ce0-49d7-88f8-5b375cbbbdc5"),
                            CategoryName = "Gym"
                        },
                        new
                        {
                            CategoryId = new Guid("894b8f1f-c2ef-4018-9008-5a47e3583b8d"),
